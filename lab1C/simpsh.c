...
int main (int argc, char** argv){
    ...
    int pf_flag;
    struct rusage usage;
    double startu, endu, utime, starts, ends, stime;
    ...
    // file open
        case 'r': //rdonly
            if (pf_flag) {
                ...
                startu = (double) usage.ru_utime.tv_sec + ((double)usage.ru_utime.tv_usec / 1000000);
                starts = (double) usage.ru_stime.tv_sec + ((double)usage.ru_stime.tv_usec / );
            }
            fd_count++;
            char* rd_arg = optarg;
            ...
            if (pf_flag) {
                    getrusage(RUSAGE_SELF, &usage);
                    endu = (double) usage.ru_utime.tv_sec + ((double)usage.ru_utime.tv_usec / 1000000);
                    ends = (double) usage.ru_stime.tv_sec + ((double)usage.ru_stime.tv_usec / );
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Rdonly, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        case 'w': //wronly
            if (pf_flag) {
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Wronly, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        case 'x'://rdwr
            if (pf_flag) {
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Rdwr, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        case 'p'://pipe
            if (pf_flag) {
            ...
            if (pf_flag) {
                ...
                utime = endu - startu;
                stime = ends - starts;
                fprintf(stdout, "Pipe, system time: %fs, user time: %fs \n", stime, utime);
            }     
            break;
    ...
    //subcommand
        case 'c'://command
            ...
            if (pid_arr[prc_count]==0){//pid = 0, child process
                ...
                if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Command, system time: %fs, user time: %fs \n", stime, utime);
                }
            }
        ...
        case 'a'://wait
            ...
            if (pf_flag) {
                ...
                utime = endu - startu;
                stime = ends - starts;
                fprintf(stdout, "Wait Self, system time: %fs, user time: %fs \n", stime, utime);
                getrusage(RUSAGE_CHILDREN, &usage);
                endu = (double) usage.ru_utime.tv_sec + ((double)usage.ru_utime.tv_usec / 1000000);
                ends = (double) usage.ru_stime.tv_sec + ((double)usage.ru_stime.tv_usec / );
                utime = endu - startu;
                stime = ends - starts;
                fprintf(stdout, "Wait Children, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
    // miscellaneous    
        case 'l'://close
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Close, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        case 'b'://abort
            if (pf_flag) {
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Abort, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        case 'h'://catch
        {
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Catch, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        }
        case 'i'://ignore
        {
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Ignore, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        }
        case 'd'://default
        {
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Default, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
        }
        case 'u'://pause
            ...
            if (pf_flag) {
                    ...
                    utime = endu - startu;
                    stime = ends - starts;
                    fprintf(stdout, "Pause, system time: %fs, user time: %fs \n", stime, utime);
            }
            break;
