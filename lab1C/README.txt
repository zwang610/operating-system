...
1. simpsh.c: simpsh.c is the source code of simpsh command. User can pass argument and command to create pipes and access files. 
...
5. report.pdf: a report on performance of simpsh comparing with dash and bash